...
import (
	...
	"github.com/kube-workspaces/controller/internal/controller"
...
func main() {
	...
	if err := (&controller.UserReconciler{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		EventRecorder: mgr.GetEventRecorderFor("user-controller"),
	}).SetupWithManager(mgr); err != nil {
	...
	if err := (&controller.AuthConfigReconciler{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		EventRecorder: mgr.GetEventRecorderFor("authconfig-controller"),
	}).SetupWithManager(mgr); err != nil {
